...
public class GameSolver {
    ...
    public Solutions findSolution (Board solution) {
        if (solution == null || solution.getBoardCells().length == 0 || solution.getBoardSquares().length == 0 || solution.getSquareDimension() == 0) return null;
        this.solution = solution;

        isEndOfProgram = false; isEndOfSolution = false; registerSolution = false; isForward = true;
